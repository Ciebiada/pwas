...
import { Header, HeaderButton, Modal, ModalPage, ModalSelect, ModalSlider, BackIcon } from 'rams';
    ...
    return (
        <div class="reader-container">
            ...
            <div class={`reader-controls-overlay ${showControls() ? 'visible' : ''}`}>
                <div class="nav-zone left" onClick={prev} onDblClick={(e) => e.preventDefault()} />
                <div
                    class="nav-zone center"
                    onClick={toggleControls}
                    onDblClick={(e) => e.preventDefault()}
                />
                <div class="nav-zone right" onClick={next} onDblClick={(e) => e.preventDefault()} />
            </div>
                ...
                >
                    <ModalPage id="root">
                        ...
                        <ModalSelect
                            ...
                            displayValue={settings().fontFamily.split(',')[0].replace(/'/g, '')}
